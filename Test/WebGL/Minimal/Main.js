...
(function (Minimal) {
    ...
    function hndLoad(_event) {
        ...
        let mtrSolidWhite2 = new ƒ.Material("SolidBlue", ƒ.ShaderUniColor, new ƒ.CoatColored(new ƒ.Color(0, 0, 1)));
        ...
        let mtrCyan = new ƒ.Material("White", ƒ.ShaderUniColor, new ƒ.CoatColored(new ƒ.Color(0, 0.8, 1)));
